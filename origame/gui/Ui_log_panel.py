...
class Ui_LogPanel(object):
    def setupUi(self, LogPanel):
        ...
        self.log_record_display = QtWidgets.QPlainTextEdit(parent=LogPanel)
        ...
        self.toggle_options_button = QtWidgets.QToolButton(parent=LogPanel)
        ...
        self.toggle_options_button.setArrowType(QtCore.Qt.ArrowType.RightArrow)
        ...
        self.options_panel = QtWidgets.QWidget(parent=LogPanel)
        ...
        self.filter_group = QtWidgets.QGroupBox(parent=self.options_panel)
        ...
        self.label_warning_logs = QtWidgets.QLabel(parent=self.filter_group)
        ...
        self.checkbox_user_print_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_system_critical_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_system_critical_logs.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.checkbox_user_critical_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.label_critical_logs = QtWidgets.QLabel(parent=self.filter_group)
        ...
        self.label_filter_system = QtWidgets.QLabel(parent=self.filter_group)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.checkbox_system_warning_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_user_error_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_user_warning_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_system_error_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_user_info_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.checkbox_system_info_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_filter_user = QtWidgets.QLabel(parent=self.filter_group)
        ...
        self.checkbox_system_debug_logs = QtWidgets.QCheckBox(parent=self.filter_group)
        ...
        self.save_button = QtWidgets.QPushButton(parent=self.filter_group)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        ...
        self.hide_prev_button = QtWidgets.QPushButton(parent=self.filter_group)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 488, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
