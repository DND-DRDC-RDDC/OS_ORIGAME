...
# Form implementation generated from reading ui file 'edit_time_dialog.ui'
#
...
class Ui_EditTimeDialog(object):
    def setupUi(self, EditTimeDialog):
        ...
        EditTimeDialog.resize(300, 200)
        EditTimeDialog.setMinimumSize(QtCore.QSize(300, 200))
        EditTimeDialog.setMaximumSize(QtCore.QSize(300, 200))
        ...
        self.buttonBox.accepted.connect(EditTimeDialog.accept)
        self.buttonBox.rejected.connect(EditTimeDialog.reject)
