...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dummy_label.setPixmap(QtGui.QPixmap("images/2dview.png"))
        ...
        self.action_toggle_toolbar.toggled['bool'].connect(self.tool_bar.setVisible)
        self.tool_bar.visibilityChanged['bool'].connect(self.action_toggle_toolbar.setChecked)
