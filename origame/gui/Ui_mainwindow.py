...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.button_goto_parent = QtWidgets.QToolButton(parent=self.title_frame)
        ...
        self.frame_2d = QtWidgets.QFrame(parent=self.central_widget)
        ...
        self.dummy_label = QtWidgets.QLabel(parent=self.frame_2d)
        ...
        self.menu_preferences = QtWidgets.QMenu(parent=self.menu_file)
        ...
        self.menu_part_view_mode = QtWidgets.QMenu(parent=self.menu_view)
        ...
        self.menu_simulation = QtWidgets.QMenu(parent=self.menubar)
        self.menu_simulation.setObjectName("menu_simulation")
        MainWindow.setMenuBar(self.menubar)
        self.scenario_browser_dock = QtWidgets.QDockWidget(parent=MainWindow)
        self.scenario_browser_dock.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetClosable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetVerticalTitleBar)
        ...
        self.treeWidget = QtWidgets.QTreeWidget(parent=self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.search_text_box = QtWidgets.QLineEdit(parent=self.layoutWidget_2)
        ...
        self.search_button = QtWidgets.QPushButton(parent=self.layoutWidget_2)
        ...
        self.search_results_list_box = QtWidgets.QListWidget(parent=self.layoutWidget_2)
        ...
        self.log_panel_dock = QtWidgets.QDockWidget(parent=MainWindow)
        self.log_panel_dock.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetClosable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetVerticalTitleBar)
        ...
        self.help_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.help_view = ContextHelp(parent=self.dockWidgetContents_4)
        ...
        self.object_properties_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.event_queue_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.main_simulation_control_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.batch_simulation_control_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.alerts_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/cut.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_cut.setIcon(icon)
        self.action_cut.setObjectName("action_cut")
        self.actionPython_CLI = QtGui.QAction(parent=MainWindow)
        ...
        self.actionNext_Window = QtGui.QAction(parent=MainWindow)
        self.actionNext_Window.setObjectName("actionNext_Window")
        self.actionPrevious_Window = QtGui.QAction(parent=MainWindow)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/save_as.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_save_as.setIcon(icon2)
        self.action_save_as.setObjectName("action_save_as")
        self.actionToggle_Dockables = QtGui.QAction(parent=MainWindow)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/paste.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_paste.setIcon(icon3)
        self.action_paste.setObjectName("action_paste")
        self.action_play_pause_sim = QtGui.QAction(parent=MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/button_playsim.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.action_step_sim = QtGui.QAction(parent=MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/button_stepsim.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_step_sim.setIcon(icon5)
        self.action_step_sim.setObjectName("action_step_sim")
        self.action_reset_sim = QtGui.QAction(parent=MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/button_resetsim.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/file_new.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_new.setIcon(icon7)
        self.action_new.setObjectName("action_new")
        self.action_export = QtGui.QAction(parent=MainWindow)
        self.action_export.setEnabled(True)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/export.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_export.setIcon(icon8)
        self.action_export.setObjectName("action_export")
        self.action_import = QtGui.QAction(parent=MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/import.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_import.setIcon(icon9)
        self.action_import.setObjectName("action_import")
        self.actionAbout_2 = QtGui.QAction(parent=MainWindow)
        self.actionAbout_2.setObjectName("actionAbout_2")
        self.action_user_manual = QtGui.QAction(parent=MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/user_manual.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_user_manual.setIcon(icon10)
        self.action_user_manual.setObjectName("action_user_manual")
        self.action_python_reference = QtGui.QAction(parent=MainWindow)
        self.action_python_reference.setObjectName("action_python_reference")
        self.action_parts_reference = QtGui.QAction(parent=MainWindow)
        self.action_parts_reference.setObjectName("action_parts_reference")
        self.action_toggle_toolbar = QtGui.QAction(parent=MainWindow)
        ...
        self.action_python_tutorials = QtGui.QAction(parent=MainWindow)
        self.action_python_tutorials.setObjectName("action_python_tutorials")
        self.action_show_examples = QtGui.QAction(parent=MainWindow)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/undo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_undo.setIcon(icon12)
        self.action_undo.setObjectName("action_undo")
        self.action_redo = QtGui.QAction(parent=MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/redo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_redo.setIcon(icon13)
        self.action_redo.setObjectName("action_redo")
        self.action_override_minimal = QtGui.QAction(parent=MainWindow)
        self.action_override_minimal.setCheckable(True)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/model_view_detail_level_minimal.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_override_minimal.setIcon(icon14)
        self.action_override_minimal.setObjectName("action_override_minimal")
        self.action_override_full = QtGui.QAction(parent=MainWindow)
        self.action_override_full.setCheckable(True)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/model_view_detail_level_full.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_override_full.setIcon(icon15)
        self.action_override_full.setObjectName("action_override_full")
        self.action_override_none = QtGui.QAction(parent=MainWindow)
        self.action_override_none.setCheckable(True)
        self.action_override_none.setChecked(True)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/view_content_individual.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_override_none.setIcon(icon16)
        self.action_override_none.setObjectName("action_override_none")
        self.actionRun_no_reset = QtGui.QAction(parent=MainWindow)
        self.actionRun_no_reset.setObjectName("actionRun_no_reset")
        self.action_debug = QtGui.QAction(parent=MainWindow)
        self.action_debug.setCheckable(True)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/debug.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.action_toggle_animation = QtGui.QAction(parent=MainWindow)
        self.action_toggle_animation.setCheckable(True)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/animation.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_toggle_animation.setIcon(icon18)
        self.action_toggle_animation.setObjectName("action_toggle_animation")
        self.action_clear_events = QtGui.QAction(parent=MainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/clear_queue.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_clear_events.setIcon(icon19)
        self.action_clear_events.setObjectName("action_clear_events")
        self.action_main_sim_settings = QtGui.QAction(parent=MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/button_simsettings.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_main_sim_settings.setIcon(icon20)
        self.action_main_sim_settings.setObjectName("action_main_sim_settings")
        self.action_run_sim = QtGui.QAction(parent=MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/button_runmain.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_run_sim.setIcon(icon21)
        self.action_run_sim.setObjectName("action_run_sim")
        self.action_batch_simulation_settings = QtGui.QAction(parent=MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/button_batchsettings.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.action_start_batch_simulation = QtGui.QAction(parent=MainWindow)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/button_runbatch.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.action_log_settings = QtGui.QAction(parent=MainWindow)
        self.action_log_settings.setObjectName("action_log_settings")
        self.action_clear_settings = QtGui.QAction(parent=MainWindow)
        self.action_clear_settings.setObjectName("action_clear_settings")
        self.actionRestore_Defaults = QtGui.QAction(parent=MainWindow)
        self.actionRestore_Defaults.setObjectName("actionRestore_Defaults")
        self.action_restore_default = QtGui.QAction(parent=MainWindow)
        self.action_restore_default.setObjectName("action_restore_default")
        self.action_save_settings = QtGui.QAction(parent=MainWindow)
        self.action_save_settings.setObjectName("action_save_settings")
        self.action_toggle_save_warning = QtGui.QAction(parent=MainWindow)
        self.action_toggle_save_warning.setCheckable(True)
        self.action_toggle_save_warning.setChecked(True)
        self.action_toggle_save_warning.setObjectName("action_toggle_save_warning")
        self.action_restore_default_view = QtGui.QAction(parent=MainWindow)
        ...
        self.menu_preferences.addAction(self.action_toggle_save_warning)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_toggle_save_warning.setText(_translate("MainWindow", "Show \"Unsaved Objects\" Warning"))
        self.action_toggle_save_warning.setToolTip(_translate("MainWindow", "Show/Hide a warning for unsaved objects when saving/loading a scenario"))
        self.action_toggle_save_warning.setStatusTip(_translate("MainWindow", "Show/Hide a warning for unsaved objects when saving/loading a scenario"))
