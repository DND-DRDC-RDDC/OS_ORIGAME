...
# Form implementation generated from reading ui file 'ui_files\input_parameters.ui'
#
...
class Ui_InputParametersDialog(object):
    def setupUi(self, InputParametersDialog):
        ...
        self.buttonBox.accepted.connect(InputParametersDialog.accept)
        self.buttonBox.rejected.connect(InputParametersDialog.reject)
