...
class Ui_InputParametersDialog(object):
    def setupUi(self, InputParametersDialog):
        ...
        self.label = QtWidgets.QLabel(parent=InputParametersDialog)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.label_2 = QtWidgets.QLabel(parent=InputParametersDialog)
        self.label_2.setObjectName("label_2")
        self.verticalLayout.addWidget(self.label_2)
        self.parameter_area = QtWidgets.QScrollArea(parent=InputParametersDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=InputParametersDialog)
