...
class Ui_DebugWidget(object):
    def setupUi(self, DebugWidget):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=DebugWidget)
        ...
        self.breakpoint_on_off_button = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.breakpoint_on_off_button.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.DefaultContextMenu)
        self.breakpoint_on_off_button.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.step_button = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.step_into_button = QtWidgets.QPushButton(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.continue_button = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.variable_refresh_button = QtWidgets.QPushButton(parent=self.groupBox)
        self.variable_refresh_button.setObjectName("variable_refresh_button")
        self.horizontalLayout_5.addWidget(self.variable_refresh_button)
        self.verticalLayout_3.addLayout(self.horizontalLayout_5)
        self.local_variables_table = QtWidgets.QTableWidget(parent=self.groupBox)
        self.local_variables_table.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.local_variables_table.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.local_variables_table.setColumnCount(2)
        self.local_variables_table.setObjectName("local_variables_table")
        self.local_variables_table.setRowCount(0)
        self.verticalLayout_3.addWidget(self.local_variables_table)
        ...
        self.evaluate_button = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.clear_button = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.expression_result_list = QtWidgets.QListWidget(parent=self.groupBox)
