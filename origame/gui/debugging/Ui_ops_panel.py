...
class Ui_DebugWidget(object):
    def setupUi(self, DebugWidget):
        ...
        self.variable_refresh_button = QtWidgets.QPushButton(self.groupBox)
        ...
        self.local_variables_table = QtWidgets.QTableWidget(self.groupBox)
        self.local_variables_table.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.local_variables_table.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
