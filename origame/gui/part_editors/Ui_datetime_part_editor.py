...
class Ui_DateTimePartEditorWidget(object):
    def setupUi(self, DateTimePartEditorWidget):
        ...
        self.label = QtWidgets.QLabel(parent=DateTimePartEditorWidget)
        self.label.setObjectName("label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label)
        self.date_edit = QtWidgets.QDateEdit(parent=DateTimePartEditorWidget)
        self.date_edit.setObjectName("date_edit")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.date_edit)
        self.label_2 = QtWidgets.QLabel(parent=DateTimePartEditorWidget)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        self.time_edit = QtWidgets.QTimeEdit(parent=DateTimePartEditorWidget)
