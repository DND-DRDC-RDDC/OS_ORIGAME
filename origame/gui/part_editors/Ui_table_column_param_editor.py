...
# Form implementation generated from reading ui file 'table_column_param_editor.ui'
#
...
class Ui_edit_column_parameters(object):
    def setupUi(self, edit_column_parameters):
        ...
        self.buttonBox.accepted.connect(edit_column_parameters.accept)
        self.buttonBox.rejected.connect(edit_column_parameters.reject)
