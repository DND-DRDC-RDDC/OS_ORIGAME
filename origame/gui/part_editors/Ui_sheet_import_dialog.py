...
class Ui_SheetImportDialog(object):
    def setupUi(self, SheetImportDialog):
        ...
        self.instructions_label = QtWidgets.QLabel(parent=SheetImportDialog)
        ...
        self.file_label = QtWidgets.QLabel(parent=SheetImportDialog)
        ...
        self.filepath_linedit = QtWidgets.QLineEdit(parent=SheetImportDialog)
        ...
        self.browse_files_button = QtWidgets.QPushButton(parent=SheetImportDialog)
        ...
        self.list_sheets_button = QtWidgets.QPushButton(parent=SheetImportDialog)
        ...
        self.sheet_label = QtWidgets.QLabel(parent=SheetImportDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sheet_combobox = QtWidgets.QComboBox(parent=SheetImportDialog)
        ...
        self.range_label = QtWidgets.QLabel(parent=SheetImportDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.range_linedit = QtWidgets.QLineEdit(parent=SheetImportDialog)
        ...
        self.help_button = QtWidgets.QPushButton(parent=SheetImportDialog)
        self.help_button.setObjectName("help_button")
        self.horizontalLayout_5.addWidget(self.help_button)
        self.button_box = QtWidgets.QDialogButtonBox(parent=SheetImportDialog)
