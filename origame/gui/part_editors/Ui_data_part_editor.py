...
class Ui_DataPartEditorWidget(object):
    def setupUi(self, DataPartEditorWidget):
        ...
        self.widget = QtWidgets.QWidget(parent=DataPartEditorWidget)
        self.widget.setObjectName("widget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.insert_before_button = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.insert_after_button = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.select_all_button = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.cut_button = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.copy_button = QtWidgets.QPushButton(parent=self.widget)
        self.copy_button.setMaximumSize(QtCore.QSize(40, 16777215))
        self.copy_button.setObjectName("copy_button")
        self.horizontalLayout_5.addWidget(self.copy_button)
        self.paste_button = QtWidgets.QPushButton(parent=self.widget)
