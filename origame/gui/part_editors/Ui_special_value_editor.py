...
class Ui_SpecialValueEditor(object):
    def setupUi(self, SpecialValueEditor):
        ...
        self.label = QtWidgets.QLabel(parent=SpecialValueEditor)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.value_edit = QtWidgets.QTextEdit(parent=SpecialValueEditor)
        ...
        self.button_box = QtWidgets.QDialogButtonBox(parent=SpecialValueEditor)
