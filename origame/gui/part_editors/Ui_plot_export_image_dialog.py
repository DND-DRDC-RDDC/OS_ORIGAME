...
# Form implementation generated from reading ui file 'ui_files\plot_export_image_dialog.ui'
#
...
class Ui_PlotExportImageDialog(object):
    def setupUi(self, PlotExportImageDialog):
        ...
        self.button_box.accepted.connect(PlotExportImageDialog.accept)
        self.button_box.rejected.connect(PlotExportImageDialog.reject)
