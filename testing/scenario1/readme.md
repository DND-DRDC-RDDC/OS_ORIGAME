...
For any new version of ORIGAME, this test is successful if running the scenario produces a batch results file that exactly matches the included "batch_results.sqlite.db" file that was generated by the current version of ORIGAME using the seeds found in the included "seeds.csv" file.
